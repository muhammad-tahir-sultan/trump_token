...
export function DashboardHero({ level }: DashboardHeroProps) {
  return (
    <section className="relative overflow-hidden rounded-[2rem] bg-slate-950 p-6 text-white shadow-xl shadow-indigo-950/20 sm:p-8">
      ...
      <div className="relative z-10 max-w-xl">
        ...
        <h3 className="mt-6 text-4xl font-black leading-tight tracking-tight sm:text-5xl">
